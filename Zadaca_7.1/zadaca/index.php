...
echo "Nisi prijavljen.<br>";
echo "<h2 style='margin:auto;max-width:300px;color:black;'>Prijavite se</h2><br>";
			...
			<table>
				...
				<tr>
					<td colspan=\"2\" align=\"center\">
								<input type=\"submit\" name=\"submit\" value=\"Podnesi ->\" style='color:white;background-color:black;'></td>
				</tr>
			</table>
		</form>";
} 
